...
public class MainPopWindow extends PopupWindow {
    ...
    public MainPopWindow(final Activity context, final OnPopWindowItemClickListener listener) {
        this.listener = listener;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        contentView = inflater.inflate(R.layout.main_popup, null);
        ...
        this.setAnimationStyle(R.style.Widget_AppCompat_PopupMenu);
        ...
        contentView.findViewById(R.id.btn_create_room).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (listener != null) {
                    listener.onCreateRoomClick();
                }
                dismiss();
            }
        });
